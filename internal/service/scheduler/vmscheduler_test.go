...
func (c fakeResourceClient) GetReservableMemoryBytes(_ context.Context, nodeName string, _ int64, _ bool) (uint64, error) {
...
func TestScheduleVM(t *testing.T) {
	...
	fakeProxmoxClient.EXPECT().GetReservableMemoryBytes(context.Background(), "pve1", int64(100), true).Return(miBytes(60), nil)
	fakeProxmoxClient.EXPECT().GetReservableMemoryBytes(context.Background(), "pve2", int64(100), true).Return(miBytes(20), nil)
	fakeProxmoxClient.EXPECT().GetReservableMemoryBytes(context.Background(), "pve3", int64(100), true).Return(miBytes(20), nil)
